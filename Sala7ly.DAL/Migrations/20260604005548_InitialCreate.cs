    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteTechnicians", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteTechnicians_CustomerProfiles_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "CustomerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteTechnicians_TechnicianProfiles_TechnicianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromptSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResponseSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AI_INTERACTIONS_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposalMessage = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bids_TechnicianProfiles_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "TechnicianProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingMode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    AiPriceMin = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    AiPriceMax = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsEmergency = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SurgeMultiplier = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 1.0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_Bids_SelectedBidId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicianReply = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Disputes_ServiceRequests_ServiceRequestId",
                        column: x => x.ServiceRequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicianPayout = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValue: "PendingDeposit"),
                    ProviderRef = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    ProviderReceiptUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DepositedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ReleasedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RefundedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DisputeId1 = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_CustomerProfiles_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "CustomerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        column: x => x.DisputeId1,
                        principalTable: "Disputes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_ServiceRequests_ServiceRequestId",
                        column: x => x.ServiceRequestId,
                        principalTable: "ServiceRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EscrowTransactions_TechnicianProfiles_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "TechnicianProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_EscrowTransactions_EscrowTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AI_INTERACTIONS_RequestId",
                table: "AI_INTERACTIONS",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_AI_INTERACTIONS_UserId",
                table: "AI_INTERACTIONS",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Disputes_EscrowTransactionId",
                table: "Disputes",
                column: "EscrowTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_Disputes_ServiceRequestId",
                table: "Disputes",
                column: "ServiceRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EscrowTransactions_ServiceRequestId",
                table: "EscrowTransactions",
                column: "ServiceRequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EscrowTransactions_TechnicianId",
                table: "EscrowTransactions",
                column: "TechnicianId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteTechnicians_CustomerId_TechnicianId",
                table: "FavoriteTechnicians",
                columns: new[] { "CustomerId", "TechnicianId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_SelectedBidId",
                table: "ServiceRequests",
                column: "SelectedBidId",
                unique: true,
                filter: "[SelectedBidId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_EscrowTransactionId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AI_INTERACTIONS_ServiceRequests_RequestId",
                table: "AI_INTERACTIONS",
                column: "RequestId",
                principalTable: "ServiceRequests",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Disputes_EscrowTransactions_EscrowTransactionId",
                table: "Disputes",
                column: "EscrowTransactionId",
                principalTable: "EscrowTransactions",
                principalColumn: "Id",
